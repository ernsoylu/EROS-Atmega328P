...
/*   TASK_APPKNBSWT  prio 1  wcet <= 2 tick(s)  (10 ms) */
#define OS_NUM_TASKS          2u

#define TASK_INIT             ((TaskType)0u)
#define TASK_APPKNBSWT        ((TaskType)1u)
...
#define RES_RTE               ((ResourceType)0u) /* users: APPKNBSWT */
...
OS_STATIC_ASSERT(
    ((1u << TASK_INIT) | (1u << TASK_APPKNBSWT)) ==
    ((1u << OS_NUM_TASKS) - 1u),
...
OS_STATIC_ASSERT((ALARM_APPKNBSWT < OS_NUM_ALARMS),
